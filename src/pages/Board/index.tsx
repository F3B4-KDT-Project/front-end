...
import { BsFillEmojiWinkFill, BsFillPeopleFill, BsFillCaretLeftFill, BsFillCaretRightFill } from "react-icons/bs";
import { 
  EmptyBoardContainer,
  Message,
  IconWrapper,
...
const dummyData = {
  ...
  posts: [
    ...
    { id: 2, name: "[FE] 모달창 컴포넌트 만들기", date: "2025.01.12 14:32", badgeCount: 3 },
    { id: 3, name: "[FE] 채팅 구현", date: "2025.01.12 14:32", badgeCount: 99 },
    { id: 4, name: "[BE] 폴더 구조", date: "2025.01.12 14:32", badgeCount: 12 },
    { id: 5, name: "[BE] 라이브러리 세팅", date: "2025.01.12 14:32", badgeCount: 1 },
  ...
  return (
    <BoardContainer>
      ...
      <EmptyBoardContainer>
        ...
        <Description>
          수업을 만들려면 <strong>우측 상단의 수업 생성 버튼</strong>을 눌러주세요!!
        </Description>
      </EmptyBoardContainer>
    </BoardContainer>
  );
